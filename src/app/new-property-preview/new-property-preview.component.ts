...
@Component({
  selector: 'app-new-property-preview',
  templateUrl: './new-property-preview.component.html',
  styleUrls: ['./new-property-preview.component.css'],
  providers : [PropertyService]
})
export class NewPropertyPreviewComponent implements OnInit {
  property : Property;
